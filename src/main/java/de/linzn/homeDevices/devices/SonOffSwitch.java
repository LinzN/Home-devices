...
public class SonOffSwitch {

    private String deviceName;
    private String hostname;

    public SonOffSwitch(String deviceName) {
        this.deviceName = deviceName;
        this.hostname = HomeDevicesPlugin.homeDevicesPlugin.getDefaultConfig().getString("sonoffSwitch." + deviceName.toLowerCase() + ".hostname");
    }
