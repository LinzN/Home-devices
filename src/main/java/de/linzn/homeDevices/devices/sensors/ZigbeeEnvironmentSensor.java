...
public class ZigbeeEnvironmentSensor extends EnvironmentSensor {
    ...
    public void request_initial_status() {
        STEMSystemApp.LOGGER.WARNING("Initial request for device " + this.getDeviceHardAddress() + " (" + MqttDeviceCategory.SENSOR.name() + ", " + this.deviceTechnology.name() + ") is not supported!");
